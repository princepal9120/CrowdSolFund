                    ...
                    <div className="max-w-3xl mx-auto text-center">
                        ...
                        >
                            <button
                                ...
                                className="inline-flex items-center gap-2 px-8 py-3 bg-emerald-600 text-white rounded-lg font-medium hover:bg-emerald-500 transition-colors cursor-pointer shadow-lg shadow-emerald-600/20"
                            >
                                Start Exploring
            ...
            <div className="relative z-10 pb-12 pt-8">
                <div className="container mx-auto px-4 md:px-6">
                    <motion.div
                        ...
                        className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 max-w-4xl mx-auto text-center"
                    >
                        <div className="flex flex-col items-center gap-2 p-4">
                            <div className="p-3 bg-white/5 rounded-full ring-1 ring-white/10 mb-2">
